        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="datatable" data-url="{{ adminUrl('collection/all') }}" class="table table-bordered dt-responsive nowrap"
        ...
        $(document).ready(function() {
            function submitForm()
            {
                $('.form-data').submit(function(e){
                    ...
                    var self = this;
                    var id = $(this).data('id');
                    var url = $(this).data('id') ? "{{adminUrl('collection')}}/" + id : "{{adminUrl('collection')}}";
                    if(id)
                    {
