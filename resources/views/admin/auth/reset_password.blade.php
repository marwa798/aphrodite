                                ...
                                <div class="p-2">
                                    ...
                                    <form class="form-horizontal" action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" value="" name="password" class="form-control" id="password" placeholder="Enter Your New Password">
                                        </div>

                                        <div class="form-group">
                                            <label for="password_confirmation">Password Confirmation</label>
                                            <input type="password" value="" name="password_confirmation" class="form-control" id="password_confirmation" placeholder="Confirm Password">
                                        </div>
                                        
                                        <div class="mt-3 text-right">
                                            <button class="btn btn-primary w-md waves-effect waves-light" type="submit">Rest New Password</button>
                                        </div>
